...
; Characteristics of each move.
	...
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           55, FIRE,         100, 25 ; magmar egg move.
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT,          55, ICE,          100, 25 ; jynx egg move.
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       55, ELECTRIC,     100, 25 ; electabuzz egg move.
	...
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 20 ; arcanine, farfetch'd, primeape, marowak.
	...
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          125, DRAGON,        90,  5 ; dragonite, gyarados (high level), mewtwo.
	...
	move ABSORB,       DRAIN_HP_EFFECT,             30, GRASS,        100, 30 ; bellsprout, bulbasaur, tangela - vinewhip; bellsprout, oddish, zubat - absorb.
	...
	move SOLARBEAM,    CHARGE_EFFECT,              125, GRASS,        100,  5
	...
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,   90, GRASS,        100, 10 ; venusaur, vileplume, victreebel.
	...
	move FIRE_SPIN,    BURN_SIDE_EFFECT1,           70, FIRE,         100, 20 ; replaced 'TRAPPING_EFFECT' with 'BURN_SIDE_EFFECT1'.
	...
	move HYPNOSIS,     SLEEP_EFFECT,                 0, PSYCHIC_TYPE,  75, 20 ; hypno, poliwhirl, exeggutor.
	...
	move AGILITY,      SPEED_UP2_EFFECT,             0, NORMAL,       100, 20 ; dodrio, electrode, arcanine, jolteon, pikachu, porygon.
	move QUICK_ATTACK, SPEED_UP1_EFFECT,            50, NORMAL,       100, 25 ; replaced 'NO_ADDITIONAL_EFFECT' with 'SPECIAL_UP1_EFFECT'. give to Beedril, Dodrio, Dugtrio, Arcanine, electric types too. TODO: test Speed +1.
	...
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        0, GHOST,        100, 25 ; give to marowak, ninetails too.
	move MIMIC,        MIMIC_EFFECT,                 0, NORMAL,       100, 10 ; TODO: scrap this move, give place to another.
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,       100, 20 ; onyx, magneton, electabuzz, electrode, persian, arbok, primeape, aerodactyl, oddish.
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, NORMAL,       100, 15 ; electrode, alakazam, ninetails, gengar.
	move RECOVER,      HEAL_EFFECT,                  0, NORMAL,       100, 15 ; vaporeon, muk, porygon, alakazam, starmie, tangela, tentacruel.
	...
	move SWIFT,        PARALYZE_SIDE_EFFECT1,       40, ELECTRIC,     100, 25 ; replaced 'SWIFT_EFFECT' with 'PARALYZE_SIDE_EFFECT1'.
	...
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,        90, 20 ; jynx, high level.
	...
	move EXPLOSION,    EXPLODE_EFFECT,             125, FIRE,         100,  5
...
;   8 - Poison Fang: Arbok, Golbat, Nidoking, Nidoqueen - POISON_SIDE_EFFECT2. (75/100/20)
