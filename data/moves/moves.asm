...
; Characteristics of each move.
	...
	move GUILLOTINE,   NO_ADDITIONAL_EFFECT,       120, BUG,           80,  5 ; removed 'OHKO_EFFECT'. passou a ser high-crit. ver se o Pinsir e Kingler não são muito rápidos (devido a crit-chance).
	...
	move ROAR,         ATTACK_UP2_EFFECT,            0, NORMAL,       100, 20 ; replaced 'SWITCH_AND_TELEPORT_EFFECT' with 'ATTACK_UP2_EFFECT'. growllithe.
	move SING,         SLEEP_EFFECT,                 0, NORMAL,        80, 20 ; jigglypuff
	move SUPERSONIC,   CONFUSION_EFFECT,             0, NORMAL,        70, 20 ; zubat
	...
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          130, DRAGON,        90,  5 ; TODO: de notar: "In Generations 1-3, all Dragon type moves were categorized as Special".
	...
	move COUNTER,      NO_ADDITIONAL_EFFECT,         1, FIGHTING,     100, 20 ; TODO: maybe change into something more useful/consistent.
	move SEISMIC_TOSS, SPECIAL_DAMAGE_EFFECT,        1, FIGHTING,     100, 20
	move STRENGTH,     ATTACK_UP1_EFFECT,           65, FIGHTING,     100, 20 ; TODO: find how to fix the 'Badge Boost glitch'.
	...
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  100, GRASS,         90, 10
	...
	move RAGE,         ATTACK_UP1_EFFECT,           55, DRAGON,        90, 20 ; replaced 'RAGE_EFFECT' with 'ATTACK_UP1_EFFECT'.
	...
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, GRASS,        100,  5
	...
	move SWIFT,        SWIFT_EFFECT,                65, ELECTRIC,     100, 20
	move SKULL_BASH,   RECOIL_EFFECT,              110, ROCK,          90, 10 ; replaced 'CHARGE_EFFECT' with 'RECOIL_EFFECT'. Pokemon: Rhyhorn, Rhydon, Onix/Steelix, Kabutops, Aerodactyl, Omastar, Geodude/Graveler/Golem, Tauros, Blastoise, Marowak, Exeggutor, Rapidash.
	...
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           110, FIGHTING,      80, 10
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  18, GRASS,         80, 20
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             65, BUG,          100, 20 ; golbat
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,        85, 15
	...
	move CONVERSION,   SPECIAL_UP2_EFFECT,            0, NORMAL,      100, 20 ; replaced 'CONVERSION_EFFECT' with 'SPECIAL_UP2_EFFECT'.
